...
def run_hspice_on_files(directory):
    ...
    for cir_file in tqdm(cir_files, desc="\033[1;32mHSPICE Simulator\033[0m: Running HSPICE simulations"):
        with open(os.devnull, 'w') as devnull:
            subprocess.run(["hspice", cir_file], cwd=HSPICE_DIR, stdout=devnull, stderr=devnull)
    
    print('\033[1;32mHSPICE Simulator\033[0m: All simulations have been completed')
